...
const DURABLE_SCHEMA_ROOTS = new Set<SchemaKey>([
  ...
  'src/coordinator/shutdown-abandonment.ts#shutdownRemainderEntrySchema',
  'src/coordinator/shutdown-abandonment.ts#shutdownRemainderRecordEnvelopeSchema',
  'src/coordinator/shutdown-abandonment.ts#shutdownRemainderStatusEnvelopeSchema',
