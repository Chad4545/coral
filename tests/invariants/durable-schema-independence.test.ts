...
const DURABLE_SCHEMA_ROOTS = new Set<SchemaKey>([
  ...
  'src/coordinator/shutdown-remainder.ts#shutdownRemainderEntrySchema',
  'src/coordinator/shutdown-remainder.ts#shutdownRemainderRecordInstanceSchema',
  'src/coordinator/shutdown-remainder.ts#shutdownRemainderRecordEnvelopeSchema',
  'src/coordinator/shutdown-remainder.ts#shutdownRemainderStatusEnvelopeSchema',
